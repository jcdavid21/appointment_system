              ...
              <li class="breadcrumb-item active">Appointments</li>
                ...
                <div class="card mb-5">
                    <div class="card-header bg-success pt-3">
                        <div class="text-center">
                            <p class="card-title text-light">Accepted Appointment Lists
                        </div>
                    </div>
                    <div class="card-body">
                ...
                <div class="card mb-5">
                    <div class="card-header bg-danger pt-3">
                        <div class="text-center">
                            <p class="card-title text-light">Declined Appointment Lists
                        </div>
                    </div>
                    <div class="card-body">
                      <table id="residenceAccounts" class="table table-striped nowrap" style="width:100%">
